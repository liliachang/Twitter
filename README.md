...
* [x] User can **click a link within a tweet body** on tweet details view. The click will launch the web browser with relevant page opened. (forgot to licecap this)
* [x] Used Parcelable instead of Serializable leveraging the popular [Parceler
...
*[x] Compose a tweet from the profile activity
## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/KKZtOee.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
